...
const ElectionsDetail = () => {
  ...
  const [electionUpData, setElectionUpData] = React.useState({
    id: id,
    title: "",
    description: "",
    location: "",
                                      ...
                                      candidateData.map((element) => {
                                        return (
                                          <Col
                                            ...
                                            <a
                                              href={
                                                `${process.env.PUBLIC_URL} /elections/` +
                                                id +
                                                `/` +
                                                element.id
                                              }
                                              className="pointer_action_button">
                                              <CandidateCard
                                                name={
                                                  element.fname +
                                                  " " +
                                      ...
                                      <Card className=" border">
                                        ...
                                        <Card.Body className=" h-100">
                                          ...
                                          <Row className=" row-sm">
                                            <div className="col">
                                              <Link
                                                to={`${process.env.PUBLIC_URL}/pages/gallery`}>
                                                <img
                                                  alt="img"
        ...
        <Col xl={3} lg={12} md={12} sm={12}>
          <Col xl={12} lg={12}>
            <Card className=" user-wideget user-wideget-widget widget-user">
              <div className="widget-user-header br-te-5  br-ts-5  bg-primary"></div>
              ...
              <div className="user-wideget-footer text-center">
                <h4 className="fs-16 mb-0 mt-3 text-dark fw-semibold"> </h4>
              </div>
              <div className="user-wideget-footer">
                <h3 className="card-title mb-2">
                  Election Title: <span>{electionData.title}</span>
                </h3>
                <h3 className="card-title mb-2">
                  Election Date: <span>{electionData.date}</span>
                </h3>
                <p>
                  <strong>Team:</strong>
                </p>
