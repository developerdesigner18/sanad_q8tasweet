      ...
      <div className="breadcrumb-header justify-content-between">
        ...
        <div className="justify-content-center mt-2">
          <Link
            ...
            onClick={() => {
              handleShow();
              setDataValue({ id: 0, name: "", menu: "", description: "" });
            }}
          >
            <i className="fe fe-plus me-2"></i>Add New Menu
          </Link>
          <Modal show={show.flag} onHide={handleClose}>
            <Modal.Header className="modal-header">
              {show.mode - 1 === 0 ? (
                ...
                <h6 className="modal-title">Update Menu </h6>
              )}
              <Button
                variant=""
                className="btn-close"
                ...
                <Form className="form-horizontal">
                  ...
                  <FormGroup className="form-group">
                    <Creatable
                      ...
                      onChange={(value) => {
                        setDataValue({ ...dataValue, menu: value });
                      }}
                      labelledBy="Select"
                      isMulti
                    />
